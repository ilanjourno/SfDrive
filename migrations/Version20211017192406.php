 ...
 */
final class Version20211017192406 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__file AS SELECT id, sub_folder_id, name, size, type, created_at, updated_at FROM file');
        ...
        $this->addSql('INSERT INTO file (id, sub_folder_id, name, size, type, created_at, updated_at) SELECT id, sub_folder_id, name, size, type, created_at, updated_at FROM __temp__file');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__file AS SELECT id, sub_folder_id, name, size, type, created_at, updated_at FROM file');
        $this->addSql('DROP TABLE file');
        $this->addSql('CREATE TABLE file (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, sub_folder_id INTEGER DEFAULT NULL, name VARCHAR(255) NOT NULL, size INTEGER NOT NULL, type VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL --(DC2Type:datetime_immutable)
