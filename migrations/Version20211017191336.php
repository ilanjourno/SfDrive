 ...
 */
final class Version20211017191336 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE file (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, sub_folder_id INTEGER DEFAULT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, size INTEGER NOT NULL, type VARCHAR(255) NOT NULL COLLATE BINARY, created_at DATETIME NOT NULL --(DC2Type:datetime_immutable)
        , updated_at DATETIME DEFAULT NULL --(DC2Type:datetime_immutable)
        , CONSTRAINT FK_8C9F3610421FFFC FOREIGN KEY (sub_folder_id) REFERENCES folder (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
